...
const checkEnvironment = () => {
    if(process.env.NODE_ENV !== 'development') {
        firstUrl = 'https://dahaotran.github.io/Bike_shop'
    }
}
...
const getTypeList = () => {
    ...
    checkEnvironment();
    return useSWR(firstUrl + '/jsons/types.json', fetcher);
}
...
const getBikeList = () => {
    ...
    // return JSON.parse(fs.readFileSync(filePath, "utf-8"));
    checkEnvironment();
    return useSWR(firstUrl + '/jsons/bikes.json', fetcher);
}
...
const getFirmList = () => {
    ...
    // return JSON.parse(fs.readFileSync(filePath, "utf-8"));
    checkEnvironment();
    return useSWR(firstUrl + '/jsons/firms.json', fetcher);
}
...
const getDetailList = () => {
    ...
    // return JSON.parse(fs.readFileSync(filePath, "utf-8"));
    checkEnvironment();
    return useSWR(firstUrl + '/jsons/bike_details.json', fetcher);
}
